...
This dashboard tracks demonstrable reality, and is kept consistent with
the canonical `+.machine_readable/6a2/STATE.a2ml+` (42%, CRG grade D).
An earlier version claimed ~80% with nearly everything "`100%
verified`"; that was false and contradicted STATE and the CRG audit.
