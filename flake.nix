{
  description = "academic-workflow-suite - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P academic-workflow-suite.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/academic-workflow-suite $out/bin/  # Rust
            # cp bin/academic-workflow-suite $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/academic-workflow-suite";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-academic-workflow-suite" {
