...
**This repository is not finished being set up.** 5 substitution token(s) across 9 file(s) still have no value.
...
- `release/flatpak/com.academicworkflow.AWS.yaml`
...
- `release/appimage/AppImageBuilder.yml`
- `release/flatpak/com.academicworkflow.AWS.yaml`
- `release/packaging/debian/changelog`
- `release/packaging/debian/control`
- `release/scripts/package.sh`
- `release/scripts/release.sh`
- `release/snap/snapcraft.yaml`
- `tasks/Justfile`
