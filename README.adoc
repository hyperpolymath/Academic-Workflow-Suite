...
│  │  Presentation Layer                                           │ │
│  │  ┌─────────────────────────────────────────────────────────┐  │ │
│  │  │  Microsoft Word + AWS Office Add-in (AffineScript)          │  │ │
│  │  │  - Task pane UI                                         │  │ │
...
|-----------|------------|---------|
| *Office Add-in* | AffineScript, Office.js, Webpack | UI and Word integration |
...
- *Frontend*: AffineScript → JavaScript, React, Office.js
...
- *[Office Add-in](components/office-addin/README.md)* - AffineScript frontend
...
│   ├── office-addin/      # AffineScript frontend (Office.js)
...
- *AffineScript*: AffineScript formatter
- *YAML*: `yamllint`
...
| [AffineScript](https://affinescript-lang.org/) | MIT | Frontend |
