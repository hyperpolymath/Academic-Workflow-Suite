...
Build the AffineScript Office add-in.
...
Run all unit tests (Rust, Elixir, AffineScript).
...
*Dependencies:* `test-rust`, `test-elixir`, `test-affinescript`
...
Run AffineScript tests for the Office add-in.

[source,bash]
----
just test-affinescript
----

==== `test-affinescript-watch`

Run AffineScript tests in watch mode.

[source,bash]
----
just test-affinescript-watch
----
...
*Dependencies:* `lint-rust`, `lint-elixir`, `lint-affinescript`, `lint-shell`, `lint-yaml`, `lint-docker`, `lint-markdown`
...
Lint AffineScript code.

[source,bash]
----
just lint-affinescript
----

==== `lint-affinescript-fix`

Lint and auto-fix AffineScript code.

[source,bash]
----
just lint-affinescript-fix
----
...
*Dependencies:* `format-rust`, `format-elixir`, `format-affinescript`, `format-toml`
...
*Dependencies:* `format`, `lint-markdown-fix`, `lint-affinescript-fix`
...
==== `dev-watch-affinescript`

Watch AffineScript files and rebuild on changes.

[source,bash]
----
just dev-watch-affinescript
----
...
*Dependencies:* `dev-watch-rust`, `dev-watch-affinescript`
...
Start a development shell with Guix.
...
*Note:* Requires Guix with flakes enabled.
...
*Dependencies:* `clean-rust`, `clean-elixir`, `clean-affinescript`, `clean-docker`, `clean-temp`
...
Clean AffineScript build artifacts.

[source,bash]
----
just clean-affinescript
----
...
just dev-watch-affinescript  # In another terminal
